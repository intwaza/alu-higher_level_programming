#!/usr/bin/python3
"""Module 6-rectangle
Defines a Rectangle class with width, height, instance counting,
area, perimeter, string representation, eval repr, and deletion message.
"""


class Rectangle:
    """Defines a rectangle with width, height and counts instances."""
